...
class TvShowViewModel extends ViewModel
{
    ...
    public function tvshow()
    {
        return collect($this->tvshow)->merge([
            ...
            // 'networks'=> 'https://image.tmdb.org/t/p/w200/'.$this->tvshow['logo_path']

        ])->only([
            'poster_path', 'id', 'genres', 'name', 'vote_average', 'overview', 'first_air_date', 'credits' ,
            'videos', 'images', 'crew','homepage','networks','logo_path','number_of_episodes','number_of_seasons', 'cast', 'images', 'created_by',
        ]);
    }
}
